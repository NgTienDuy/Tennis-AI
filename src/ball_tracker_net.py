...
def train(model_saved_state=None, epochs_num=100, lr=1.0, num_classes=256, batch_size=1):
    ...
    for epoch in range(epochs_num):
        ...
        if epoch % 50 == 49:
            ...
            PATH = f'./models/tracknet_weights_lr_{lr}_epochs_{total_epochs}.pth'
...
if __name__ == "__main__":
    '''state = torch.load("./models/tracknet_weights_lr_1.0_epochs_125_256_classes.pth")
    ...
    for lr in [0.05]:
        ...
        train("./models/tracknet_weights_lr_1.0_epochs_250.pth",epochs_num=300, lr=lr, num_classes=2,
              batch_size=2)
